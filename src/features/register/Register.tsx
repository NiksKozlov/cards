  ...
  return (
    <div className={s.mainContainer}>
      <div className={s.formContainer}>
        <ErrorSnackbar serverError={serverError} setServerErrorAction={setRegisterServerError} />
        <h1>Sign Up</h1>
        <form onSubmit={formik.handleSubmit}>
          <FormGroup sx={{ width: "350px" }}>
            ...
            />
            {formik.errors.confirmPassword ? <div className={s.error}>{formik.errors.confirmPassword}</div> : null}
